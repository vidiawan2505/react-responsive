        ...
        <div className='cards__container'>
            <div className='cards__wrapper'>
                ...
                <CardItem src='images/img-3.jpg' text='Set sail in the Atlantic Ocean visiting Uncharted Waters' label='Mystery' path='/services'/>
                    <CardItem src='images/img-4.jpg' text='Expreience Football on Top of the Himalayan Mountains' label='Adventure' path='/services'/>
                    <CardItem src='images/img-8.jpg' text='Ride through the Sahara Deser on a guided camel' label='Adrenaline' path='/services'/>
                </ul>
            </div>
        </div>
    </div>
